...
- (void)viewDidLoad
{
    ...
    UIPanGestureRecognizer *panGesture = [[UIPanGestureRecognizer alloc] initWithTarget:self action:@selector(containerViewDidPan:)];
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer
{
    ...
    if (gestureRecognizer && myPanGesture == self.panGesture)
    {
	BOOL isOpen = (self.containerLeftEdgeConstraint.constant < 1);
	return !isOpen;
    }
